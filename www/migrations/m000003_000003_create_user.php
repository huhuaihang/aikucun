...
class m000003_000003_create_user extends Migration
{
    public function safeUp()
    {
        ...
        $this->createIndex('fk_user_level1_idx', '{{%user}}', ['level_id']);
        try {
            $this->addForeignKey('fk_user_level1', '{{%user}}', ['level_id'], '{{%user_level}}', ['id']);
        } catch (Exception $e) {
            Yii::error($e->getMessage());
        }
        $this->createIndex('user_invite_code', '{{%user}}', ['invite_code'], true);
