 ...
 * @package app\models
 */
class WeixinMpApi extends Model
{
    /**
     * @var string 接口域名
     */
    ...
    {
        $this->app_id = System::getConfig('weixin_mp_app_id');
        $this->app_secret = System::getConfig('weixin_mp_app_secret');
        $this->mch_id = System::getConfig('weixin_mp_mch_id');
        $this->api_key = System::getConfig('weixin_mp_api_key');
        $this->cert_file = System::getConfig('weixin_mp_cert_file');
        $this->key_file = System::getConfig('weixin_mp_key_file');
