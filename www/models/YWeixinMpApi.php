 ...
 * @package app\models
 */
class YWeixinMpApi extends Model
{
    /**
     * @var string 接口域名
     */
    ...
    {
        $this->app_id = 'wxa6942b9a3b9a16ac';//System::getConfig('weixin_mp_app_id');
        $this->app_secret = '73c5fcff2d2fb5841c9d1b9efc7fac82';//System::getConfig('weixin_mp_app_secret');
        $this->mch_id = '1497317182';//System::getConfig('weixin_mp_mch_id');
        $this->api_key = 'yunmaimaiyunmaimai20202020yunmai';//System::getConfig('weixin_mp_api_key');
