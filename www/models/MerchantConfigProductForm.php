 ...
 * @package app\models
 */
class MerchantConfigProductForm extends Model
{
    /**
     * @var int mid
     */
    ...
    {
        return [
            [['mid', 'goods_sales_licenses', 'inspection_reports', 'industry_files'], 'required'],
            [['status'], 'safe'],
        ];
    }
    ...
    public function save()
    {
        ...
        try {
            $merchant = Merchant::findOne($this->mid);
            MerchantConfig::setConfig($merchant->id, 'goods_sales_licenses', $this->goods_sales_licenses);
            MerchantConfig::setConfig($merchant->id, 'inspection_reports', $this->inspection_reports);
            MerchantConfig::setConfig($merchant->id, 'industry_files', $this->industry_files);
