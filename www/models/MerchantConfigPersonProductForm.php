 ...
 * @package app\models
 */
class MerchantConfigPersonProductForm extends Model
{
    /**
     * @var int mid
     */
    ...
    {
        return [
            [['mid', 'goods_sales_licenses'], 'required'],
            [['status', 'inspection_reports', 'industry_files'], 'safe'],
        ];
    }
    ...
    public function save()
    {
        ...
        try {
            ...
            MerchantConfig::setConfig($merchant->id, 'inspection_reports', !empty($this->inspection_reports) ? $this->inspection_reports : '');           MerchantConfig::setConfig($merchant->id, 'industry_files', !empty($this->industry_files) ? json_encode($this->industry_files) :'');
