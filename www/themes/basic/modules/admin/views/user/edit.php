...
<?php echo $form->field($model, 'commission_ratio_1');?>
<?php echo $form->field($model, 'commission_ratio_2');?>
<?php echo $form->field($model, 'commission_ratio_3');?>
