...
<div class="form-group field-mobile_list required">
    <label class="control-label" for="from_uid">发送补贴人员</label>
    ...
    <label class="control-label" for="to_uid">接收补贴人员</label>
    <input id="to_uid" class="form-control" name="to_uid" aria-required="true">
