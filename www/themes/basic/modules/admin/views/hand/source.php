...
<br/>
<div class="form-group">
    <a class="btn btn-success btn-sm" href="<?php echo Url::to(['/admin/hand/source-edit']);?>">添加</a>
</div>
    ...
    <?php foreach ($sourceList as $source) {?>
        <tr id="data_<?php echo $source->id;?>">
            ...
            <td><?php echo ManagerTableOp::widget(['items' => [
                    ['icon' => 'fa fa-pencil', 'href' => Url::to(['/admin/hand/source-edit', 'id' => $source->id]), 'btn_class' => 'btn btn-xs btn-success', 'tip' => '修改', 'color' => 'green'],
...
<script>
    ...
    function deleteSource(id) {
        ...
        $.getJSON('<?php echo Url::to(['/admin/hand/delete-source']);?>', {'id':id}, function (json) {
            if (callback(json)) {
                $('#data_' + id).remove();
            }
        });
