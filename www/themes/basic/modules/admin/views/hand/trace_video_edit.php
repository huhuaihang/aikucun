...
<?php echo $form->field($traceVideo, 'start_time')->textInput(['value'=>Yii::$app->formatter->asDatetime($traceVideo->start_time), 'class'=>'form-control masked', 'data-mask'=>'9999-99-99 99:99:99']);?>
