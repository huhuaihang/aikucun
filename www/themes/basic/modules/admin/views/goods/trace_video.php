...
<br/>
<div class="form-group">
    <a class="btn btn-success btn-sm" href="<?php echo Url::to(['/admin/goods/trace-video-edit']);?>">添加</a>
</div>
    ...
    <?php foreach ($videoList as $video) {?>
        <tr id="data_<?php echo $video->id;?>">
            ...
            <td><?php echo ManagerTableOp::widget(['items' => [
                    ['icon' => 'fa fa-pencil', 'href' => Url::to(['/admin/goods/trace-video-edit', 'id' => $video->id]), 'btn_class' => 'btn btn-xs btn-success', 'tip' => '修改', 'color' => 'green'],
...
<script>
    ...
    function deleteVideo(id) {
        ...
        $.getJSON('<?php echo Url::to(['/admin/goods/delete-video']);?>', {'id':id}, function (json) {
            if (callback(json)) {
                $('#data_' + id).remove();
            }
        });
