...
<div class="box">
    ...
    <div class="product_details">
        ...
        <div class="div2">
            ...
            <div class="commission commission_1"><p>分享最低赚¥<?php echo $goods->share_commission_value * 30 / 100;?><span class="commission_fen">分享</span></p></div>
            <div class="div2_p2">
        ...
        <div class="bottom form_btn">
            <div class="left">
                <!--<a href="<?php echo Url::to(['/h5/shop/view', 'id' => $goods->sid]);?>">-->
                    <!--<dl class="dl1">-->
                        <!--<dt><img src="/images/talk_06.jpg"></dt>-->
                        <!--<dd>店铺</dd>-->
                    <!--</dl>-->
                <!--</a>-->
                <a href="tel:18006490976">
<!--                        href="--><?php //echo Url::to(['/h5/message/chat', 'sid' => $goods->sid, 'gid' => $goods->id]);?><!--">-->
                    <dl>
