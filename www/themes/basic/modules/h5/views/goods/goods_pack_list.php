...
<!--                        <div class="cp_text">-->
<!--                            <h3>{{goods['title']}}</h3>-->
<!--                            <p>售价：<span>¥</span><span class="price">{{goods['price']}}</span></p>-->
<!--                            <p>已售<span class="price-s">{{ goods['sale_amount'] }}</span>件</p>-->
<!--                        </div>-->
<!--                    </a>-->
<!--                </li>-->
<!--            </ul>-->
            <div class="member">
                ...
                <a  v-for="goods in goods_list" :href="'/h5/goods/view?id='+goods['id']">
                    <img :src="goods['main_pic']" width="710" height="250"/>
                </a>
            </div>
        </div>
    </div>
