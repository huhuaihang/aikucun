...
new AjaxUpload($("#pics_button"),{
    ...
    onComplete: function(file, resp){ //完成后回调函数
        if(typeof(upload_callback) == 'function'){
            ...
            html += '<input type="hidden" value="'+resp.url+'" name="'+inputName+'[]" ><a class="thumbnail" title="点击查看大图" href="'+resp.url+'" target="_blank"><img name="'+resp.path+'" class="img-responsive" src="'+resp.url+'" style="width: 225px;height: 120px!important;" ></a>';
            html += '</div>'
